...
public class SystemCameraActivity extends AppCompatActivity {
    ...
    private Uri getUriForFile(String path) {
        Uri uri = FileProvider.getUriForFile(getBaseContext(),"com.bytedance.mediahomework.fileprovider",new File(path));
        return uri;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            imageView.setImageBitmap(rotateBitmap(bitmap,takeImagePath));
            // todo 1.5 注意图片大小
        }
    }
